...
export class updatePostTable1678532914341 implements MigrationInterface {
    name = 'updatePostTable1678532914341'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "ratings" ("id" BIGSERIAL NOT NULL, "rate" integer NOT NULL, "productId" bigint, "userId" bigint, CONSTRAINT "REL_4d0b0e3a4c4af854d225154ba4" UNIQUE ("userId"), CONSTRAINT "PK_0f31425b073219379545ad68ed9" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "products" ("id" BIGSERIAL NOT NULL, "name" character varying NOT NULL, "price" integer NOT NULL, "description" character varying NOT NULL, "quantity" integer NOT NULL, "categoryId" bigint, "brandId" bigint, CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" BIGSERIAL NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL, "banned" boolean NOT NULL DEFAULT false, "banReason" character varying NOT NULL DEFAULT '', "userInfoId" bigint, "cartId" bigint, "userRoleId" bigint, CONSTRAINT "REL_e43569535ff044bc1626bbeb7f" UNIQUE ("userInfoId"), CONSTRAINT "REL_89502c44bd22c06e714c31c1e9" UNIQUE ("cartId"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
